...
'''
ROOT.gROOT.SetPadTickX(1);             # Sets tic marks on both horiz
ROOT.gROOT.SetPadTickY(1);             # Sets tic marks on both verti
ROOT.gROOT.SetTickLength(0.018,"xyz"); # Sets tic length
